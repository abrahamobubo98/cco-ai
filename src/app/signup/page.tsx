...
export default function Signup() {
  ...
  async function handleSignup(formData: FormData) {
    'use server'
    // For development, we'll accept any signup and redirect to onboarding
    // In a real app, you would validate and create an account here
    
    // Simulate a delay to make it feel like an actual signup
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-black text-gray-800 dark:text-gray-100">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-2xl font-bold text-gray-900 dark:text-white">Create your account</h2>
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Or <Link href="/login" className="text-purple-600 hover:text-purple-500">sign in to your existing account</Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" action={handleSignup}>
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                type="text"
                autoComplete="name"
                defaultValue="John Doe" // Pre-fill for development
                required
          ...
          <div className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
            <p>Development note: Use any information to sign up</p>
          </div>
        </form>
      </div>
    </div>
